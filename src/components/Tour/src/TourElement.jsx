...
export const TourElement = ({ ariaAttributes, hideCloseButton, hideBackButton }) => {
   ...
   return (
      <>
         <div className={`${css["c-layout"]}`}></div>
         <div
         ...
         >
            ...
            <div aria-hidden={true} className={css["c-tour-progress"]}>
               <div className={css["c-tour-progress-bar"]} style={{ transform: `scaleX(${id / lastId})` }}></div>
            </div>
